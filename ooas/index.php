<?php
    session_start();
    if (isset($_SESSION['username']) === false || strpos($_SESSION['profile'], 'ooas') === false) {
...
<html> 
    ...
    <center> 
        <div id="conteneur" class="conteneur" > 
            ...
            <?php
            echo "Elements for OOAS Instance"
            ?>
    ...
    <script type="text/javascript" >
        ...
        $(document).ready(function(){
            ...
            $('#a_ooas').removeClass('class_a_menu_haut');
            $('#a_ooas').addClass('class_menu_haut_active');
