...
$(document).ready(function() {
    ...
    $('#sbt_resultats').click(function() {
        $('#sbt_resultats').hide();
        $('#res_loader').show();
        var numero_reclamation = $.trim($('#numero_reclamation').val());
        var email = $.trim($('#email').val());
        if (numero_reclamation === '' || email === '') {
            $('#res_loader').hide();
            $('#sbt_resultats').show();
        ...
        if ($.isNumeric(numero_reclamation) === false) {
            $('#res_loader').hide();
            $('#sbt_resultats').show();
            alertify.alert('ERREUR : veuillez corriger le numero de declaration!');
            return false;
        }
