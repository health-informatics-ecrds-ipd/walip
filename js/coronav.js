...
$(document).ready(function() {
	fillTable("cap_form0", 97, 1, true);
	fillTable("cap_form1", 1, 1, true);
	fillTable("cap_form2", 2, 5, true);
	fillTable("cap_form3", 7, 24, true);
	fillTable("cap_form4", 31, 19, true);
	fillTable("cap_form5", 50, 12, true);
	fillTable("cap_form6", 62, 10, true);
	fillTable("cap_form7", 72, 25, true);
