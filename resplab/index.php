<?php
    session_start();
    if (isset($_SESSION['username']) === false || strpos($_SESSION['profile'], 'resplab') === false) {
...
<html> 
    ...
    <center> 
        <div id="conteneur" class="conteneur" > 
            ...
            <?php
            echo "Elements for Responsable Labo"
            ?>
    ...
    <script type="text/javascript" >
        ...
        $(document).ready(function(){
            ...
            $('#a_resplab').removeClass('class_a_menu_haut');
            $('#a_resplab').addClass('class_menu_haut_active');
