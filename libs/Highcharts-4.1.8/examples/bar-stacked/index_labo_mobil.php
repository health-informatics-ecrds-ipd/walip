...
var chart = null;
$(function () {
	var datedeb = "<?php if (isset($_GET['datedeb'])) echo ($_GET['datedeb']); else echo ""; ?>";
	var datefin = "<?php if (isset($_GET['datefin'])) echo ($_GET['datefin']); else echo ""; ?>";
	var date_switch = "<?php if (isset($_GET['date_switch'])) echo ($_GET['date_switch']); else echo ""; ?>";
	
	$.post('post_bar_labo_mobil.php',{
			'datedeb':datedeb,
		 	'datefin':datefin, 
        ...
        chart = $('#container').highcharts({
            ...
            title: {
            	style:{ "fontSize": "14px"}, 
                text: "EVOLUTION JOURNALIERE ["+(npositives)+" Pos ("+npositves_pcr+" PCR, "+npositves_serologie+" S\351ro.), "+nnegatives+" N\351g, "+nen_cours+" EN COURS]"
            },
            xAxis: {
                categories: lab
            },
