...
<script type="text/javascript">
	$(document).ready(function() {   
		$(function () {
			$.post('post_bar_by_clage.php', function(data) {
				var positives_pcr = [];
				var npositves_pcr = 0;
		        ...
		        $('#container').highcharts({
		            ...
		            title: {
		            	style:{ "fontSize": "14px"},
		                text: "REPARTITION PAR CLASSE D'AGE / ["+(npositives)+" Pos ("+npositves_pcr+" PCR, "+npositves_serologie+" S\351ro.), "+nnegatives+" N\351g, "+nen_cours+" EN COURS]"
		            },
		            xAxis: {
		                categories: lab
		            },
