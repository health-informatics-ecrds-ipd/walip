	...
	$.post('post_bar_by_week.php',{
	 ...
	 var positives_pcr = [];
        ...
        $('#container').highcharts({
            ...
            title: {
            	style:{ "fontSize": "14px"},
            	text: "EVOLUTION HEBDOMADAIRE ["+(npositives)+" Pos ("+npositves_pcr+" PCR, "+npositves_serologie+" S\351ro.), "+nnegatives+" N\351g, "+nen_cours+" EN COURS]"
            },
            xAxis: {
                categories: lab
            },
