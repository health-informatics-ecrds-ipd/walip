...
$query = "SELECT 
				...
				count( if(manifestations_hemorragiques = 1  ,1,NULL)) as manifestations_hemorragiques ,
				count( if(meningo_encephalite = 1  ,1,NULL)) as meningo_encephalite ,
				count( if(icteres = 1  ,1,NULL)) as icteres,
		
				if(igm_". $diagnostique ." = 1 OR arn_". $diagnostique ." = 1, 1,
					if((igm_". $diagnostique ." = 2 AND arn_". $diagnostique ." = 2 ) 
								...
								OR ((igm_". $diagnostique ." IS NULL OR igm_". $diagnostique ." = 0) AND arn_". $diagnostique ." = 2)  ,2,NULL)) as statut,
						
				count( if(igm_". $diagnostique ." = 1 OR arn_". $diagnostique ." = 1 , 1, NULL)) as npos,
						
				count( if((igm_". $diagnostique ." = 2 AND arn_". $diagnostique ." = 2 ) 
								OR (igm_". $diagnostique ." = 2 AND (arn_". $diagnostique ." IS NULL OR arn_". $diagnostique ." = 0))
								OR ((igm_". $diagnostique ." IS NULL OR igm_". $diagnostique ." = 0) AND arn_". $diagnostique ." = 2)  ,1,NULL)) as nneg
